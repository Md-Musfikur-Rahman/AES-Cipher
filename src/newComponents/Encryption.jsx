...
export default function Encryption() {
  ...
  const handleEncryptClick = () => {
    ...
    const expandedKey = keyExpansion(keyBytes, keySize);
    setRoundKeys(expandedKey);

    setCiphertext(encrypted);
  };

  const keyExpansion = (keyBytes, keySize) => {
    const wordCount = keySize / 32;
